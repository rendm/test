...
console.log(sessionStorage.getItem('task_set_map_id'),'获取到的id的呀')
...
function getMapCoordinate() {
    ...
    var mapid=sessionStorage.getItem('task_set_map_id');
    //alert(mapid);
...
function drawDotByDb() {
    ...
    var tasktype = getQueryString('poiType');
    //alert(tasktype);
...
$('.center-img').click(function (e) {
    ...
    if(dot_clicked!=null && dot_clicked!=undefined){
        ...
        $("#left-hand").attr('pointId',dot_clicked.id)
        ...
        layer.confirm('是否选择'+$("#left-hand").attr('poiName')+'?',function () {
            //sessionStorage.setItem('welcomeguest_poiname',$("#left-hand").attr('poiName'));
            //sessionStorage.setItem('welcomeguest_poiid',$("#left-hand").attr('pointId'));

            parent.welcomeguest_poiname=$("#left-hand").attr('poiName');
            parent.welcomeguest_poiid=$("#left-hand").attr('pointId');
            //alert(welcomeguest_poiname);
            //alert(welcomeguest_poiid);
...
$('.stop-task').click(function () {
    var url=share+'/irobotweb/task/control/pausetask';
