;(function($, window, document, undefined){
	...
	Dragslot.prototype = {
		...
		_dragStart : function(e){
			...
			console.log(document.querySelector('.slot-item').clientWidth)
			dragItem.css('width',document.querySelector('.slot-item').clientWidth+6+ 'px');
			console.log(dragItem.previousSibling)
		...
		_dragEnd : function(e){
			...
			self.pointEl = null;
			var seto = self.toSlot;
            if (seto.hasClass(self.options.emptySlotClass)){
                seto.removeClass(self.options.emptySlotClass);
            }
